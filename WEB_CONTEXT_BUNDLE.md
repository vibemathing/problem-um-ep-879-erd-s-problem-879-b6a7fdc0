...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-879-erd-s-problem-879-b6a7fdc0-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-879"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-879-erd-s-problem-879-b6a7fdc0-v1",
      "problem_contract_sha256": "91dc2763c8dd8b108850faa272b5993e0fdd49ff025401a60d4e28c2d16509ac",
      "problem_id": "problem:um-ep-879-erd-s-problem-879-b6a7fdc0",
      "route_id": "route:um-ep-879-erd-s-problem-879-b6a7fdc0-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-879-erd-s-problem-879-b6a7fdc0-source-fidelity-01",
      "graph_id": "graph:um-ep-879-erd-s-problem-879-b6a7fdc0-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-879-erd-s-problem-879-b6a7fdc0-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-879-erd-s-problem-879-b6a7fdc0-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Call a set $S\\subseteq \\{1,\\ldots,n\\}$ admissible if $(a,b)=1$ for all $a eq b\\in S$. Let $ G(n) = \\max_{S\\subseteq \\{1,\\ldots,n\\}} \\sum_{a\\in S}a $ and $ H(n)=\\sum_{p<n}p+ n\\pi(n^{1/2}). $ Is it true that $ G(n) >H(n)-n^{1+o(1)}? $ Is it true that, for every $k\\geq 2$, if $n$ is sufficiently large then the admissible set which maximises $G(n)$ contains at least one integer with at least $k$ prime factors?"
          },
          "statement_sha256": "eca6d8e14f817efe921a1653f91af0a430d48c381cafcdd444885097f7d8057f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-879-erd-s-problem-879-b6a7fdc0-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-879-erd-s-problem-879-b6a7fdc0-root",
      "route_id": "route:um-ep-879-erd-s-problem-879-b6a7fdc0-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-879-e5962528aa98",
        "url": "https://www.unsolvedmath.com/problems/EP-879"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
